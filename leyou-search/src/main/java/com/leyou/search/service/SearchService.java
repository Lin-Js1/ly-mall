...
public class SearchService {
    ...
    public Goods bulidGoods(Spu spu) throws IOException {
        ...
        //根据spuId查询所有的sku
        List<Sku> skus = this.goodsClient.querySkuSpuId(spu.getId());
        ...
        skus.forEach(sku -> {
            ...
            //获取sku中的图片，数据库中的图片，可能是多张，多张是以“,”分隔，所以用逗号切割后取第一张
    ...
    public SearchResult search(SearchRequest request) {
        ...
        BoolQueryBuilder basicQuery = builBoolQueryBuilder(request);
     ...
     * @return
     */
    private BoolQueryBuilder builBoolQueryBuilder(SearchRequest request) {
